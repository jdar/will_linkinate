# derived from http://github.com/dfischer/rspec-haml-scaffold-generator/tree/master
# I'm currently patching, and adding a few options for :accessible => true
class LinkinateScaffoldGenerator < Rails::Generator::NamedBase
